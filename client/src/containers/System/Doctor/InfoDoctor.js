...
import styles from "./InfoDoctor.module.scss";
...
const InfoDoctor = (props) => {
  ...
  useEffect(() => {
    (async () => {
      await props.getDoctorByIdRedux(user.id);
    })();
  }, [user]);
    ...
    <>
      ...
      >
        ...
        >
          {resSaveDetailDoctor === 0 ? (
            <FormattedMessage id="Doctor.infoDoctor.save_success" />
          ) : (
            <FormattedMessage id="Doctor.infoDoctor.save_error" />
          )}
        </Alert>
      </Snackbar>
      {/* Container */}
      <div className={styles.container}>
        <h1 className={styles.header}>
          <FormattedMessage id="Doctor.infoDoctor.title" />
        </h1>
            ...
            <div className={styles.doctor_category}>
              ...
              <FormControl variant="outlined" className={styles.doctor_price}>
                ...
                <Select
                  ...
                  label={<FormattedMessage id="manager-doctor.price" />}
                >
                  {resPrice &&
                    resPrice.length > 0 &&
              ...
              {/* Thanh toán */}
              <FormControl variant="outlined" className={styles.doctor_payment}>
                ...
                <Select
                  ...
                  label={<FormattedMessage id="manager-doctor.payment" />}
                >
                  {resPayment &&
                    resPayment.length > 0 &&
              ...
              >
                ...
                <Select
                  ...
                  label={<FormattedMessage id="manager-doctor.specialty" />}
                >
                  {dataSpecialty &&
              ...
              >
                ...
                <Select
                  ...
                  label={<FormattedMessage id="manager-doctor.province" />}
                >
                  {resProvince &&
              ...
              {/* Phòng khám */}
              <FormControl variant="outlined" className={styles.doctor_clinic}>
                ...
                <Select
                  ...
                  label={<FormattedMessage id="manager-doctor.clinic" />}
                >
              ...
              <FormControl variant="outlined" className={styles.doctor_note}>
                ...
                <OutlinedInput
                  ...
                  label={<FormattedMessage id="manager-doctor.note" />}
                />
              </FormControl>
            </div>
            {/* Miêu tả bác sĩ */}
